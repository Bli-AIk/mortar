...
mod type_checking_tests {
    ...
    fn create_test_program_with_functions(functions: Vec<FunctionDecl>, nodes: Vec<NodeDef>) -> Program {
    ...
    fn test_function_argument_count_mismatch() {
        ...
        let function = FunctionDecl {
            ...
            name_span: Some((0, 9)),
            params: vec![
                Param { name: "param1".to_string(), type_name: "String".to_string() },
                Param { name: "param2".to_string(), type_name: "Number".to_string() },
            ],
            return_type: None,
        };
        ...
        assert!(diagnostics.iter().any(|d| matches!(d.kind, DiagnosticKind::ArgumentCountMismatch { .. })));
    }
    ...
    fn test_function_argument_type_mismatch() {
        ...
        assert!(collector.has_errors());
        let diagnostics = collector.get_diagnostics();
        assert!(diagnostics.iter().any(|d| matches!(d.kind, DiagnosticKind::ArgumentTypeMismatch { .. })));
    }
    ...
    fn test_when_condition_type_mismatch() {
        ...
        assert!(collector.has_errors());
        let diagnostics = collector.get_diagnostics();
        assert!(diagnostics.iter().any(|d| matches!(d.kind, DiagnosticKind::ConditionTypeMismatch { .. })));
    }
    ...
    fn test_nested_function_call_type_checking() {
        ...
        let outer_function = FunctionDecl {
            ...
            name_span: Some((0, 7)),
            params: vec![
                Param { name: "input".to_string(), type_name: "String".to_string() },
            ],
            return_type: None,
        };
        ...
        let program = create_test_program_with_functions(
            vec![outer_function, inner_function], 
            vec![node]
        );
        collector.analyze_program(&program);
    ...
    fn test_correct_types_no_errors() {
        ...
        let function = FunctionDecl {
            ...
            name_span: Some((0, 7)),
            params: vec![
                Param { name: "text".to_string(), type_name: "String".to_string() },
                Param { name: "count".to_string(), type_name: "Number".to_string() },
            ],
            return_type: None,
        };
