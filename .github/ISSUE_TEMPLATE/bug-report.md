---
name: Bug report
about: Report a bug or unexpected behavior in mortar
...
3. How are you using mortar? (e.g., running with `cargo run`, building as a library)
